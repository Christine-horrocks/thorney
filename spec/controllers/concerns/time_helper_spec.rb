...
RSpec.describe TimeHelper, type: :helper do
  ...
  describe '#paragraph_time_translation_object' do
    it 'creates a hash which can be passed to a paragraph serializer as content' do
      ...
      expect(paragraph_time_translation_object_example).to eq({ :content=>"shared.time-html-to", :date_default=>"23 December 2016", :date_default_second=>"23 December 2017", :datetime_format=>"2016-12-23", :datetime_format_second=>"2017-12-23" })
    end
